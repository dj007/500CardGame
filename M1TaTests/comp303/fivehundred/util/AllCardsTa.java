...
public interface AllCardsTa
{
	public static final Card aAC = new Card(Card.Rank.ACE, Card.Suit.CLUBS);
	public static final Card aAC2 = new Card(Card.Rank.ACE, Card.Suit.CLUBS);
	...
	public static final Card aLJo = new Card(Card.Joker.LOW);
	public static final Card aHJo = new Card(Card.Joker.HIGH);
}
